    ...
    <div className="stage">
      ...
      >
        ...
        <section className="terms-sec" id="cancel">
          ...
          <p className="terms-p">
            ご予約の変更・キャンセルが必要になった場合は、お早めにご連絡ください。
          </p>
          <p className="terms-p">
            ご予約時刻から10分以上ご連絡がない場合は、予約を取り消すことがあります。
            遅れて到着される場合も、次の予約状況によってはコース時間を短縮、または
            ご案内をお断りすることがあります。分かり次第ご連絡ください。
          </p>
          <p className="terms-p">
            無断キャンセルを繰り返された場合は、以後のご予約をお断りすることがあります。
          </p>
          <div className="terms-cancel-box" role="note">
            <div className="terms-cancel-h">キャンセル料について</div>
            <p>
              キャンセル料の詳細は現在確認中です。確定後にこのページに掲載し、
              ご予約時にもご案内します。確定するまでの間、キャンセル料は発生しません。
            </p>
          </div>
        </section>
